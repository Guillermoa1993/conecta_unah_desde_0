...
import {
  Home, Calendar, QrCode, History, Plus, Users, Settings,
  Shield, FileText, ChevronDown, ChevronUp,
  GraduationCap, MapPin, Bell, LogOut, Rss, KeyRound, User,
  Wifi, ShieldCheck, ClipboardList, SendHorizonal, LayoutGrid, Info,
  Database, RefreshCcw,
} from "lucide-react";
import {
...
const MAINTENANCE_ITEMS = [
  ...
  { icon: Database,      label: "Backup",                subPath: "/maintenance/backup"              },
  { icon: RefreshCcw,    label: "Reset",                 subPath: "/maintenance/reset"               },
];
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              {/* Aplicativos y Acerca de — mismos para todos los roles */}
              <SidebarMenuItem className="mt-2 pt-2 border-t border-white/10">
                <SidebarMenuButton
                  asChild
                  isActive={location.pathname === "/employees/aplicativos"}
                  tooltip="Aplicativos"
                  className={location.pathname === "/employees/aplicativos"
                    ? "bg-[#FFD100] text-[#003366] hover:bg-[#FFD100] hover:text-[#003366]"
                    : "text-white hover:bg-[#003366] hover:text-white"}
                >
                  <Link to="/employees/aplicativos">
                    <LayoutGrid className="h-5 w-5" />
                    {!isCollapsed && <span>Aplicativos</span>}
                  </Link>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton
                  asChild
                  isActive={location.pathname === "/employees/acerca-de"}
                  tooltip="Acerca de"
                  className={location.pathname === "/employees/acerca-de"
                    ? "bg-[#FFD100] text-[#003366] hover:bg-[#FFD100] hover:text-[#003366]"
                    : "text-white hover:bg-[#003366] hover:text-white"}
                >
                  <Link to="/employees/acerca-de">
