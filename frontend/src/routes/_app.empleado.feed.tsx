...
export const Route = createFileRoute("/_app/empleado/feed")({
  component: EmployeeFeed,
});
      ...
      <div className="space-y-3">
        {nuevos.map((e) => (
          ...
          >
            ...
            >
              <Link to="/empleado/events/$id" params={{ id: e.id }}>
