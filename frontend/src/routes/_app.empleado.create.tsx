...
export const Route = createFileRoute("/_app/empleado/create")({
...
function CreateEvent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const isVoae = data.tipo_evento === "HORAS_VOAE";
    ...
    EVENTS.unshift({
      ...
      estado: isVoae ? "BORRADOR" : "PROGRAMADO",
    ...
    toast.success(isVoae ? "Evento guardado como borrador" : "Evento publicado exitosamente");
    navigate({ to: "/empleado/eventos" });
  };
    ...
    <div className="h-full flex flex-col justify-center">
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label>Categoría / Ámbito</Label>
            <Select value={data.categoria} onValueChange={(v) => set("categoria", v)}>
              <SelectTrigger className={cn("mt-1 h-11", errors.categoria && "border-red-500")}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        {data.tipo_evento === "SIN_HORAS" && (
          <div className="flex gap-6 pt-1">
            <label className="flex items-center gap-2 text-sm cursor-pointer">
              <Checkbox
                checked={data.registro_entrada}
                onCheckedChange={(v) => set("registro_entrada", v === true)}
              />
              <span>Asistencia de entrada</span>
            </label>
            <label className="flex items-center gap-2 text-sm cursor-pointer">
              <Checkbox
                ...
                onCheckedChange={(v) => set("registro_salida", v === true)}
              />
              <span>Asistencia de salida</span>
            </label>
          </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          ...
          <div>
            ...
            <Input
              ...
              className={cn("mt-1 h-11", errors.hora_inicio && "border-red-500")}
            />
            {errors.hora_inicio && (
          ...
          <div>
            ...
            <Input
              ...
              className={cn("mt-1 h-11", errors.hora_fin && "border-red-500")}
            />
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            {errors.duracion_horas && (
              <p className="text-xs mt-0.5 text-red-800">{errors.duracion_horas}</p>
            )}
      ...
      <div className="space-y-4">
        ...
        {data.usa_imagen_personalizada ? (
          <div className="space-y-6">
            ...
            {/* Subsection B — Imágenes del evento */}
            <div>
      ...
      <div className="space-y-3 overflow-y-auto">
        <div className="rounded-lg border p-4">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 text-sm">
            ...
            <div>
              ...
              {CATEGORY_LABEL_LONG[data.categoria]}
            </div>
            <div>
        ...
        <div className="rounded-lg border p-4">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 text-sm">
            ...
            <div>
              <span className="text-muted-foreground">Duración:</span> {data.duracion_horas || "—"}{" "}
              hrs ({data.tipo_duracion === "TOTALES" ? "totales" : "diarias"})
            </div>
            <div>
                  ...
                  currentStep === 1
                    ...
                    : currentStep === 2
                      ? !step2Complete ||
                        ...
                        !!(errors.duracion_horas || errors.cupo_maximo)
                      : false
                }
                className={cn(
                  "gap-1.5",
