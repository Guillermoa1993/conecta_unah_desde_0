...
CREATE TABLE IF NOT EXISTS tabla_grupo_1_usuarios (
...
CREATE INDEX IF NOT EXISTS idx_tg1_usuarios_correo ON tabla_grupo_1_usuarios(correo);
CREATE INDEX IF NOT EXISTS idx_tg1_usuarios_estado ON tabla_grupo_1_usuarios(estado);

CREATE TABLE IF NOT EXISTS tabla_grupo_1_roles (
